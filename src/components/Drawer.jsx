...
export default function Drawer({ open, onClose, title, children, footer }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      <div className="relative ml-auto flex h-full w-full sm:max-w-[620px] animate-slide-in-right flex-col border-l border-white/40 vl-glass-side shadow-valence-lg">
