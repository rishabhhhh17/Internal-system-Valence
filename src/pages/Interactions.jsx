...
function mandateModeLabel(row) {
  switch (row.mandate_link_mode) {
    ...
    // Old-shape rows (pre mandate_link_mode) show as "General" rather than a
    // user-facing "Legacy" — an internal term that shouldn't leak to the team.
...
export default function Interactions() {
  ...
  function convertToOrigination(row) {
    // Opens the Deal Logger pre-filled with the counterparty as the prospective
    // client. Client-side navigate (not window.location) so the SPA doesn't do a
    // full white-flash reload and lose in-memory state.
