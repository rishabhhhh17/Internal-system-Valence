...
export default function Mandates() {
  ...
  // always calls the current closure — otherwise a teammate's write after the
  // user flips the pipeline would refetch with the STALE pipelineMode and
  // repopulate the tracker with the wrong pipeline's deals.
  ...
  useEffect(() => {
    ...
    const off = subscribeTable('deals', () => loadRef.current({ silent: true }))
    return () => off()
  }, [])
