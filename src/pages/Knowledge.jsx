...
function FileCard({ file, onDelete }) {
  ...
  return (
    <article className="vl-card vl-card-hover p-4 group relative">
      ...
      {/* Visible by default on touch (no hover) + keyboard focus; fades to
          hover-only on pointer devices so the card stays clean. Without this
          the Download/Delete actions are unreachable on iPad/phone. */}
      <div className="mt-3 flex items-center justify-end gap-1 opacity-100 transition focus-within:opacity-100 sm:opacity-0 sm:group-hover:opacity-100">
