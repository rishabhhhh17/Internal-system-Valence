  ...
  return (
    <div className="vl-card p-8 text-center space-y-3">
      ...
      <div className="max-w-md mx-auto h-1.5 rounded-full bg-valence-surface overflow-hidden">
        {phase === 'thinking' ? (
          // The LLM call has no real progress to report — an indeterminate
          // sliding bar reads as "working" instead of a determinate bar frozen
          // at 70% (which looks hung).
          <div className="h-full w-1/3 rounded-full bg-valence-blue animate-indeterminate" />
        ) : (
          <div
    ...
    <div className="space-y-4">
      <div className="vl-card p-6 text-center space-y-3">
        ...
        <div className="flex items-center justify-center gap-2 pt-2">
          ...
          <Link to="/people" className="vl-btn-secondary-sm">See people</Link>
          <Link to="/deals" className="vl-btn-secondary-sm">See deals</Link>
        </div>
      </div>
      {fail.length > 0 && (
        <div className="vl-card p-5">
